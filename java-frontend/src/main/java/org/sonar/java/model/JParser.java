...
//    astParser.setStatementsRecovery(true);
  ...
  private static Iterator<Tree> iteratorFor(Tree node) {
    if (node.kind() == Tree.Kind.INFERED_TYPE || node.kind() == Tree.Kind.TRIVIA || node.kind() == Tree.Kind.TOKEN) {
    ...
    switch (node.getNodeType()) {
      ...
      case ASTNode.PRIMITIVE_TYPE: {
        ...
        switch (e.getPrimitiveTypeCode().toString()) {
          ...
          case "byte":
            return new JavaTree.PrimitiveTypeTreeImpl(lastTokenIn(e, TerminalTokens.TokenNamebyte));
          case "short":
            return new JavaTree.PrimitiveTypeTreeImpl(lastTokenIn(e, TerminalTokens.TokenNameshort));
          case "char":
            return new JavaTree.PrimitiveTypeTreeImpl(lastTokenIn(e, TerminalTokens.TokenNamechar));
          case "int":
            return new JavaTree.PrimitiveTypeTreeImpl(lastTokenIn(e, TerminalTokens.TokenNameint));
          case "long":
            return new JavaTree.PrimitiveTypeTreeImpl(lastTokenIn(e, TerminalTokens.TokenNamelong));
          case "float":
            return new JavaTree.PrimitiveTypeTreeImpl(lastTokenIn(e, TerminalTokens.TokenNamefloat));
          case "double":
            return new JavaTree.PrimitiveTypeTreeImpl(lastTokenIn(e, TerminalTokens.TokenNamedouble));
          case "boolean":
            return new JavaTree.PrimitiveTypeTreeImpl(lastTokenIn(e, TerminalTokens.TokenNameboolean));
          case "void":
            return new JavaTree.PrimitiveTypeTreeImpl(lastTokenIn(e, TerminalTokens.TokenNamevoid));
        }
      }
  ...
  private ModifierTree convertModifier(IExtendedModifier node) {
    switch (((ASTNode) node).getNodeType()) {
      ...
      case ASTNode.MODIFIER: {
        ...
        org.sonar.plugins.java.api.tree.Modifier m = org.sonar.plugins.java.api.tree.Modifier.valueOf(e.getKeyword().toString().toUpperCase());
        switch (e.getKeyword().toString()) {
          default:
            throw new IllegalStateException(e.getKeyword().toString());
          case "public":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNamepublic));
          case "protected":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNameprotected));
          case "private":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNameprivate));
          case "static":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNamestatic));
          case "abstract":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNameabstract));
          case "final":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNamefinal));
          case "native":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNamenative));
          case "synchronized":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNamesynchronized));
          case "transient":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNametransient));
          case "volatile":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNamevolatile));
          case "strictfp":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNamestrictfp));
          case "default":
            return new ModifierKeywordTreeImpl(m, firstTokenIn(e, TerminalTokens.TokenNamedefault));
        }
      }
    }
  }
